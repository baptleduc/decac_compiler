...
public class Selection extends AbstractLValue {
    ...
    public Type verifyExpr(DecacCompiler compiler, EnvironmentExp localEnv,
        ...
        if (!envExp2.getCurrentEnvironment().containsKey(selectedField.getName())) {
            throw new ContextualError(selectedField.getName() + " is not a field of class " + typeClass2.getName(),
        ...
        if (selectedFieldDefinition.getVisibility().equals(Visibility.PUBLIC)) {
            ...
            if (currentClass == null) {
                throw new ContextualError("can access a protected field only in daughters classes",
                        selectedField.getLocation());
            }
