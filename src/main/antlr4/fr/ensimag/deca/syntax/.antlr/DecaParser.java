// Generated from /root/Documents/GL/gl12/src/main/antlr4/fr/ensimag/deca/syntax/DecaParser.g4 by ANTLR 4.13.1
...
public class DecaParser extends AbstractDecaParser {
	...
	public static final int
		...
		NULL=9, READINT=10, READFLOAT=11, PRINT=12, PRINTX=13, PRINTLN=14, PRINTLNX=15, 
		PROTECTED=16, RETURN=17, THIS=18, TRUE=19, WHILE=20, IDENT=21, INT=22, 
		...
		SEMI=38, EQEQ=39, NEQ=40, GEQ=41, LEQ=42, AND=43, OR=44, EXP=45, DEC=46, 
		FLOATDEC=47, DIGITHEX=48, NUMHEX=49, FLOATHEX=50, FLOAT=51, STRING=52, 
		MULTI_LINE_STRING=53, WS=54, COMMENT=55, MONO_LIGNE_COMMENT=56, INCLUDE=57;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'NEW'", "'null'", "'readInt'", "'readFloat'", "'print'", "'printx'", 
			"'println'", "'printlnx'", "'protected'", "'return'", "'this'", "'true'", 
			"'while'", null, null, "'<'", "'>'", "'='", "'+'", "'-'", "'*'", "'/'", 
			"'%'", "'.'", "','", "'('", "')'", "'{'", "'}'", "'!'", "';'", "'=='", 
			"'!='", "'>='", "'<='", "'&&'", "'||'"
		};
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "ASM", "CLASS", "EXTENDS", "ELSE", "FALSE", "IF", "INSTANCEOF", 
			"NEW", "NULL", "READINT", "READFLOAT", "PRINT", "PRINTX", "PRINTLN", 
			"PRINTLNX", "PROTECTED", "RETURN", "THIS", "TRUE", "WHILE", "IDENT", 
			"INT", "LT", "GT", "EQUALS", "PLUS", "MINUS", "TIMES", "SLASH", "PERCENT", 
			"DOT", "COMMA", "OPARENT", "CPARENT", "OBRACE", "CBRACE", "EXCLAM", "SEMI", 
			"EQEQ", "NEQ", "GEQ", "LEQ", "AND", "OR", "EXP", "DEC", "FLOATDEC", "DIGITHEX", 
			"NUMHEX", "FLOATHEX", "FLOAT", "STRING", "MULTI_LINE_STRING", "WS", "COMMENT", 
			"MONO_LIGNE_COMMENT", "INCLUDE"
		};
	}
	...
	public final Decl_varContext decl_var(AbstractIdentifier t) throws RecognitionException {
		...
		try {
			...
			;
			        ((Decl_varContext)_localctx).tree =  new DeclVar(t, ((Decl_varContext)_localctx).i.tree, init_tree);
			...
			if (_la==EQUALS) {
				...
				((Decl_varContext)_localctx).e = expr();
				        ...
				        init_tree = new Initialization(((Decl_varContext)_localctx).e.tree);
				        ((Decl_varContext)_localctx).tree =  new DeclVar(t, ((Decl_varContext)_localctx).i.tree, init_tree);
				        setLocation(_localctx.tree, (((Decl_varContext)_localctx).i!=null?(((Decl_varContext)_localctx).i.start):null));
	...
	public final List_instContext list_inst() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 6755820490391392L) != 0)) {
				{
				{
				setState(122);
	...
	public final If_then_elseContext if_then_else() throws RecognitionException {
		...
		try {
			...
			match(CBRACE);
			        ...
			        ((If_then_elseContext)_localctx).tree =  new IfThenElse(((If_then_elseContext)_localctx).condition.tree, ((If_then_elseContext)_localctx).li_if.tree, else_tree);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					match(CBRACE);
					        ...
					        ((If_then_elseContext)_localctx).tree =  new IfThenElse(((If_then_elseContext)_localctx).elsif_cond.tree, ((If_then_elseContext)_localctx).list_inst.tree, else_tree);
	...
	public final List_exprContext list_expr() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 6755545611243296L) != 0)) {
				{
				setState(214);
	...
	public final IdentContext ident() throws RecognitionException {
		...
		try {
			...
			((IdentContext)_localctx).id = match(IDENT);
			        ...
			        ((IdentContext)_localctx).tree =  new Identifier(symbolTable.create((((IdentContext)_localctx).id!=null?((IdentContext)_localctx).id.getText():null)));
